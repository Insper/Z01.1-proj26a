...
def test_memoryio():
    run(vhdl_sources=[source('memoryio.vhd'),source('../CPU_FPGA/Dispositivos/ram16k.vhd'),source('../../b_logComb/src/mux4way16.vhd'),source('../../d_logSeq/src/register16.vhd'),source('../../d_logSeq/src/register8.vhd'),source('../../d_logSeq/src/binarydigit.vhd'),source('../../d_logSeq/src/flipflopd.vhd'),source('../../b_logComb/src/mux2way.vhd')], 
    toplevel="memoryio", 
    python_search=[os.path.join(os.path.dirname(__file__), 'test_cases')],
    module='tb_MemoryIO', 
    toplevel_lang="vhdl")
